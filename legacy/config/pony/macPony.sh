...
brew install cowsay 
brew insatll fortune
brew install lolcat


cowsay -bdgpstwy "installation is done"

sleep 1 
cowsay -f cheese ok you will like this  
sleep 1 # this line is purely for dramatic effect
figlet you will love it | lolcat -a -d 3
sleep 2
cowsay -f tux no really
sleep 2
echo it will be cool | lolcat -a
sleep 1
echo ok
sleep 1
echo 3
...
sleep 5
echo now add the command on like 27 to your .bashrc or .zshrc or figh config 
